...
<body style="background-color: black">
  ...
  <p style="color: white;font-size: 25px;position: absolute;padding-left: 420px;">ACCOUNT SUCCESSFULLY CREATED</p>
	<br><br><br><br><br>
    ...
    <a style="position:absolute;display: inline-block;font-size: 20px;padding-left: 50px;margin-top:100px;text-align: center;padding-right: 50px;width: 200px;margin-left: 100px;padding-top: 5px;padding-bottom: 5px;background-color:white ;text-decoration: none;color: black;width:auto;" href="signupnew.php" target="">
        SIGN UP
      </a>
